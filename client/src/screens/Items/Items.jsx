      ...
      { props.user ? <ItemCards /> :
        <>
          ...
          <div className="funny-gifs">
            <img src="https://media0.giphy.com/media/3ohfFucMqPjwFq5f7W/giphy.gif" alt="clueless" />
            <img src="https://studentlife.uiowa.edu/assets/wp-old/2014/05/new-girl-gif1.gif" alt="girl crying" />
            <img src="https://i.pinimg.com/originals/dd/74/41/dd7441477760a25ed30bc6e7aceae639.gif" alt="clueless clip" />
          </div>
          <br />
